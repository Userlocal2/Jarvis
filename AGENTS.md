...
2. Read `USER.md` — this is the routing layer for who you're helping
2a. Then read the active person profile referenced by `USER.md` (for example `profiles/artem.md`) and, when relevant, `profiles/_shared-family.md`
